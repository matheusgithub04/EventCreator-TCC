...
<link href="stylecad1.css" rel="stylesheet">
...
<body class="body">
    <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
        <a class="navbar-brand" href="home.jsp" style="width: 40%; height: 30%;" >
    ...
    <div class="">
        <div class="">
            <div class="card container">
                ...
                <div class="card-body">
                    <h5 class="card-title text-dark">Digite seus dados</h5>
                    <form class="form" method="POST" action="process">
                        <div class="md-form input-group input-group-sm mb-3" id="cpf">
                            <input type="text" class="form-control mr-2" placeholder="CPF" name="cpf" id="cpf1" required minlength="14">
                        </div>
						
						<div class="md-form input-group input-group-sm mb-3" id="senha">
                            <input type="password" class="form-control mr-2" placeholder="Senha" name="senha" required minlength="3">
                        </div>

                        <div class="md-form input-group input-group-sm mb-3" id="confirmarsenha">
                            <input type="password" class="form-control" placeholder="Confirmar senha" name="confirmarsenha" required minlength="3">
                        </div>

                        <div class="md-form input-group input-group-sm mb-3" id="nome">
                            <input type="text" class="form-control mr-2" placeholder="Nome" name="nome" required>
                        </div>

                        <div class="md-form input-group input-group-sm mb-3" id="telefone">
                            <input type="text" class="form-control" placeholder="Telefone" id="telefone1" name="telefone" required minlength="15">
                        </div>

                        <div class="md-form input-group input-group-sm mb-3" id="logradouro">
                            <input type="text" class="form-control mr-2" placeholder="Logradouro" name="logradouro" required>
                        </div>

                        <div class="md-form input-group input-group-sm mb-3" id="numero">
                            <input type="text" class="form-control" placeholder="Número" name="numero" required> 
                        </div>

                        <div class="md-form input-group input-group-sm mb-3" id="bairro">
                            <input type="text" class="form-control mr-2" placeholder="Bairro" name="bairro" required>
                        </div>

                        <div class="md-form input-group input-group-sm mb-3" id="complemento">
                            <input type="text" class="form-control mr-2" placeholder="Complemento" name="complemento">
                        </div>

                        <div class="md-form input-group input-group-sm mb-3" id="cidade">
                            <input type="text" class="form-control" placeholder="Cidade" name="cidade"required>
                        </div>

                        <div class="md-form input-group input-group-sm mb-3">
                            <select class="form-control" style="color: black;" id="estado" name="estado" required>
                        ...
                        <button id="botao" type="submit" class="button btn-block">Cadastrar</button>
                        <br>
                    </form>
                </div>
            </div>
