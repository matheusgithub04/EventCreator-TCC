...
<body class="body">
	...
	<nav class="navbar navbar-expand-lg navbar-light" id="navbar">
        <a class="navbar-brand" href="#teste2.html" style="width: 30%; height: 20%;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" style="color: white;" href="#sectioncards">OQUE OFERECEMOS <span
                            class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" style="color: white;" href="#sectionApp">NOSSO APP</a>
                </li>
            </ul>
    ...
    <div class="container">
        <div class="col-2 container col-8">
            <div class="card container">
                ...
                <div class="card-body">
                    <form method="POST" action="process">
                        ...
                        <div class="md-form input-group input-group-sm mb-3">
                            <input type="password" class="form-control" placeholder="Confirmar senha" id="senhaconfir" name="senhaconfir">
                        </div>
                        ...
                        <div class="md-form input-group input-group-sm mb-3">
                            <select class="form-control" style="color: black;" id="estado" name="estado" required="true">
								<option style="color: black;" value="AC">Acre</option>
								<option style="color: black;" value="AL">Alagoas</option>
								<option style="color: black;" value="AP">Amapá</option>
								<option style="color: black;" value="AM">Amazonas</option>
								<option style="color: black;" value="BA">Bahia</option>
								<option style="color: black;" value="CE">Ceará</option>
								<option style="color: black;" value="DF">Distrito Federal</option>
								<option style="color: black;" value="ES">Espírito Santo</option>
								<option style="color: black;" value="GO">Goiás</option>
								<option style="color: black;" value="MA">Maranhão</option>
								<option style="color: black;" value="MT">Mato Grosso</option>
								<option style="color: black;" value="MS">Mato Grosso do Sul</option>
								<option style="color: black;" value="MG">Minas Gerais</option>
								<option style="color: black;" value="PA">Pará</option>
								<option style="color: black;" value="PB">Paraìba</option>
								<option style="color: black;" value="PR">Paraná</option>
								<option style="color: black;" value="PE">Pernambuco</option>
								<option style="color: black;" value="PI">Piauí­</option>
								<option style="color: black;" value="RJ">Rio de Janeiro</option>
								<option style="color: black;" value="RN">Rio Grande do Norte</option>
								<option style="color: black;" value="RS">Rio Grande do Sul</option>
								<option style="color: black;" value="RO">Rondônia</option>
								<option style="color: black;" value="RR">Roraima</option>
								<option style="color: black;" value="SC">Santa Catarina</option>
								<option style="color: black;" value="SP">Sâo Paulo</option>
								<option style="color: black;" value="SE">Sergipe</option>
								<option style="color: black;" value="TO">Tocantins</option>
							</select>
                        </div>
                         <input type="hidden" name="action" value="cadall">
                        <button type="submit" class="button btn-block">Cadastre-se</button>
                        <br>
                    </form>
                </div>
            </div>
