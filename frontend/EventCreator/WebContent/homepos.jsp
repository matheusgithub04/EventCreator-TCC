...
<body>
	...
	%>
			<div class="alert alert-danger" align="center">
				Parabéns, evento cadastro com sucesso!
			</div>
	<%			
			}else{
	%>			
			<script>
		 		alert("Erro ao cadastrar, informações preenchidas incorretamente.");
		 		window.location.href = "http://"+b632ee66b82e.ngrok.io+"/EventCreator/cadEvent.jsp";
			</script>
	<%			
			}
		}
    ...
    <section id="sectioncards">
        <header id="headercards" style="text-align: center;">
            ...
            <h6 style="color: #fff; font-size: 25px; line-height: 1.2; text-align: center;">Para começar a utilizar
                escolha uma das duas opções abaixo.</h6>
        </header>
        <div class="container" style="padding-top: 3rem; margin-top: 3rem;">
            <div class="box">
                ...
                <div class="content" style="font-weight: bold;">
                    ...
                    <p>O EventCreator permite que o usuário crie campenatos sejam eles em grupo ou individuais, o
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <p>Veja os eventos disponiveis e participe do evento que mais chamou sua atenção.</p>
                    <div style="border-bottom: 5rem solid transparent;"></div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6" style="margin-right: 25%; padding-top: 5rem;">
                    ...
                    <p class="text-justify;" style="color: #ff1040;">O sistema Event Creator funciona da seguinte maneira. O usuário irá se
                        cadastrar e terá sua própria conta, visualizando os tipos de torneio e o número de participantes
                        do grupo para a realização deste evento, poderá também monitorar a situação de seu time, se está
                        sendo uma equipe imbatível, mediana ou perdedora. E os novos jogos que ocorrerá futuramente.</p>
                </div>
    ...
    <%}else{ %>
    	...
    	<script>alert("Você precisa estar logado para acessar essa página.");
    			window.location.href = "http://"+b632ee66b82e.ngrok.io+"/EventCreator/login.jsp";
    	</script>
    <%} %>
</body>
</html>